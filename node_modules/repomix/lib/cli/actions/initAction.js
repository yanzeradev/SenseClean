...
export const runInitAction = async (rootDir, isGlobal) => {
...
export const createConfigFile = async (rootDir, isGlobal) => {
...
export const createIgnoreFile = async (rootDir, isGlobal) => {
    if (isGlobal) {
